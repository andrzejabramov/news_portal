...
| 1.4 | Пустой username | Оставить username пустым → Submit | Ошибка валидации | ✅ | <a href="../img/scren1_4.png" target="_blank">📸</a> |
...
| 2.6 | Вход через Yandex (новый) | Клик Yandex → авторизация → новый email | Форма подтверждения или авто-регистрация | ✅ | <a href="../img/scren2_6.png" target="_blank">📸</a> |
