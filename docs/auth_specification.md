...
| 6.6 | Пагинация | Создать 11+ новостей → `/news/` | Страница 1 из 2, кнопки «Вперёд», «Последняя» | ✅ | <a href="../img/scren6_6.png" target="_blank">📸1</a> <a href="../img/scren6_6_1.png" target="_blank">📸2</a>                                                                    |
| 6.7 | Поиск | `/news/search/` | Форма с полями (Название, Автор, Дата) | ✅ | <a href="../img/scren6_7.png" target="_blank">📸1</a> <a href="../img/scren6_7_1.png" target="_blank">📸2</a> <a href="../img/scren6_7_2.png" target="_blank">📸3</a> <a href="../img/scren6_7_3.png" target="_blank">📸4</a> |
