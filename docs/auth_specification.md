...
| 3.3 | common → редактирование | Войти как common → `/news/news/<id>/edit/` | **403 Forbidden** | ✅ | <a href="../img/scren3_3.png" target="_blank">📸</a> <a href="../img/scren3_3_1.png" target="_blank">📸2</a>  |
| 3.4 | common → удаление | Войти как common → `/news/news/<id>/delete/` | **403 Forbidden** | ✅ | <a href="../img/scren3_3.png" target="_blank">📸</a> <a href="../img/scren3_3_1.png" target="_blank">📸2</a>  |
| 3.5 | Страница «Стать автором» | `/accounts/become-author/` → POST | Пользователь добавлен в `authors` | ✅ | <a href="../img/scren3_5.png" target="_blank">📸</a> <a href="../img/scren3_5_1.png" target="_blank">📸2</a>  |
...
| № | Сценарий | Действия | Ожидаемый результат | Статус | Скриншот |
|---|----------|----------|---------------------|--------|----------|
| 4.1 | Создание новости (author) | Заполнить форму → Save | Редирект на `/news/<pk>/`, новость создана | ✅ | <a href="../img/scren4_1.png" target="_blank">📸</a> |
| 4.2 | Создание статьи (author) | `/news/articles/create/` → Save | Тип = `Статья`, не видна в списке новостей | ✅ | <a href="../img/scren4_2.png" target="_blank">📸</a> |
| 4.3 | Создание без авторизации | Выйти → `/news/news/create/` | Редирект на `/accounts/login/` | ✅ | <a href="../img/scren4_3.png" target="_blank">📸</a> |
| 4.4 | Редактирование: успех | Войти как author → свой пост → edit → Save | Изменения сохранены, редирект на пост | ✅ | <a href="../img/scren4_4.png" target="_blank">📸</a> |
| 4.5 | Удаление: успех | Войти как author → свой пост → delete → Confirm | Пост удалён, редирект на `/news/` | ✅ | <a href="../img/scren4_5.png" target="_blank">📸</a> |
...
| 4.8 | Клик по заголовку | Клик на заголовок в списке | Открывается `/news/<pk>/` | ✅ | <a href="../img/scren4_8.png" target="_blank">📸</a> |
| 4.9 | Кнопки на странице деталей | Открыть свою новость → `/news/<pk>/` | Кнопки «✏️ Редактировать» / «🗑️ Удалить» видны | ✅ | <a href="../img/scren4_9.png" target="_blank">📸</a> |
...
|---|--------------|------------------|---------------|--------|----------|
| 5.1 | ✅ Success (зелёный) | Успешная регистрация | Зелёный блок с сообщением | ✅ | <a href="../img/scren5_1.png" target="_blank">📸</a> |
| 5.2 | ✅ Success (зелёный) | Успешный вход | Зелёный блок с сообщением | ✅ | <a href="../img/scren5_2.png" target="_blank">📸</a> |
| 5.3 | ✅ Success (зелёный) | «Стать автором» → Confirm | «Теперь вы можете создавать публикации!» | ✅ | <a href="../img/scren5_3.png" target="_blank">📸</a> |
| 5.4 | ✅ Success (зелёный) | Успешное создание поста | Зелёный блок с сообщением | ✅ | <a href="../img/scren5_4.png" target="_blank">📸</a> |
| 5.5 | ✅ Success (зелёный) | Успешное редактирование | Зелёный блок с сообщением | ✅ | <a href="../img/scren5_5.png" target="_blank">📸</a> |
| 5.6 | ✅ Success (зелёный) | Успешное удаление | Зелёный блок с сообщением | ✅ | <a href="../img/scren5_6.png" target="_blank">📸</a> |
| 5.7 | ❌ Error (красный) | Ошибка валидации формы | Красный блок `⚠️ Исправьте ошибки:` + список | ✅ | <a href="../img/scren5_7.png" target="_blank">📸</a> |
| 5.8 | ❌ Error (красный) | 403 Forbidden | Страница/блок: «❌ У вас отсутствуют права...» | ✅ | <a href="../img/scren5_8.png" target="_blank">📸</a> |
...
| № | Сценарий | Действия | Ожидаемый результат | Статус | Скриншот |
|---|----------|----------|---------------------|--------|----------|
| 6.1 | Навигация для гостя | Открыть `/news/` без входа | Кнопки «Войти» / «Регистрация» | ✅ | <a href="../img/scren6_1.png" target="_blank">📸</a> |
| 6.2 | Навигация для автора | Войти как author → `/news/` | «Привет, {username}!», «+ Новая новость», «Выйти» | ✅ | <a href="../img/scren6_2.png" target="_blank">📸</a> |
| 6.3 | Отображение группы | Войти → проверить шапку | `(common)` или `(authors)` рядом с именем | ✅ | <a href="../img/scren6_3.png" target="_blank">📸</a> |
| 6.4 | CSS стили | Открыть любую страницу | Стили из `navigation.css` применяются | ✅ | <a href="../img/scren6_4.png" target="_blank">📸</a> |
| 6.5 | Таблица новостей | `/news/` | Таблица с колонками (Тип, Дата, Название, Содержание, Рейтинг, Автор, Действия) | ✅ | <a href="../img/scren6_5.png" target="_blank">📸</a> |
...
| 6.8 | Футер | Проверить низ страницы | `© 2026 News Portal` | ✅ | <a href="../img/scren6_8.png" target="_blank">📸</a> |
